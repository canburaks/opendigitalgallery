...
import { BodyX, HeadlineX, SectionContainer } from '@/components';
        ...
        <section className="bg-[#FCF8F1] bg-opacity-30 py-10 sm:py-12 lg:py-24 min-h-[700px] rounded-[42px]">
          <div className="px-4 mx-auto max-w-8xl sm:px-6 lg:px-8">
            <div className="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
              <div>
                <HeadlineX className="font-bold !text-gray-900 tracking-tighter">
                  {t(TRX.INSTAPRINT.HERO_TITLE)}
                </HeadlineX>
                <BodyX className="!text-gray-700 mt-8 font-normal tracking-tight">
                  {t(TRX.INSTAPRINT.HERO_DESCRIPTION)}
                </BodyX>
                <motion.a
                  ...
                  title=""
                  className="inline-flex intense-shadow uppercase justify-between items-center bg-black px-6 !py-2 mt-8 font-semibold !text-white bg-primary rounded-lg lg:mt-16 overflow-hidden"
                  role="button"
                >
