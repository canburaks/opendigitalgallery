  ...
  return (
    <LinkComponent className="w-full group">
      <div className="border-1 border-solid border-gray-100">
        <div className="w-full relative h-[300px] break500:h-[500px] break1000:h-[600px] overflow-hidden mb-2  ">
          <ImageWithFallback
            src={default_image_url || ''}
            alt={default_image_alt || ''}
            sizes="800px"
            fill
            className="w-full object-cover  group-hover:scale-105 duration-1000 "
          />
        </div>
