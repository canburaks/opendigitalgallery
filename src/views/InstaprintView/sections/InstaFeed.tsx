...
const MediaGrid = () => {
	...
	return (
		<motion.div className="relative w-full max-w-6xl items-center flex flex-col h-auto" ref={observe}>
...
const SelectedLabel = ({ id }: { id: string }) => {
	...
	return (
		...
		>
			<motion.div
				className="relative w-40 h-auto px-8 py-6 rounded-xl overflow-hidden flex justify-center bg-transparent"

			>
				<span className="font-bold uppercase text-white">{t(TRX.INSTAPRINT.APP_MODAL_SELECTED)}</span>
				{/* <AnimatePresence>
