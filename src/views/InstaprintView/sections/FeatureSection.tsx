...
import { BodyX, Headline } from '@/components';
    ...
    <div className="px-4 mx-auto max-w-8xl sm:px-6 lg:px-8">
      <div className="grid items-center max-w-8xl grid-cols-1 mx-auto gap-y-12 lg:grid-cols-1 gap-x-16 xl:gap-x-24">
        <div className="max-w-8xl mx-auto text-center lg:mx-auto lg:text-left flex flex-col items-center">
          ...
          <Headline className="mt-12 font-bold !text-gray-900 text-center tracking-tight">
            {title}
          </Headline>
          <BodyX className="mt-6 font-medium !text-gray-700 text-center tracking-tight">
            {description}
          </BodyX>
          <div className="mt-4">
            <motion.a
              ...
              className="inline-flex intense-shadow items-center justify-between uppercase bg-[#000] px-6 !py-2 mt-8 font-semibold !text-white bg-primary rounded-lg lg:mt-16 overflow-hidden"
              role="button"
            >
