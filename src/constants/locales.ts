...
export const COUNTRY_CODE_LIST = [1, 90] as const;

export const I18N: any = {
  [LocaleEnum.EN]: { currency: 'USD', locale: 'en', country: 'US', code: 1 },
  [LocaleEnum.TR]: { currency: 'TRY', locale: 'tr', country: 'TR', code: 90 },
};
// type I18NItemType = {
